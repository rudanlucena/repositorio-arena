                            ...
                            <?php
                                include("../conexao.php"); 
                                            ...
                                            $vencimento = $_POST['vencimento'];
                                                    ...
                                                    $sql ="INSERT INTO liga (tipo, nome, data, hora, local, clubes, organizador, facebook, fone, inscricao, primeiro_lugar, segundo_lugar, terceiro_lugar, quarto_lugar, quinto_lugar, data_upload, vencimento) 
                                                        values ('$tipo', '$nome', '$data', '$hora', '$local', '$clubes', '$organizador', '$facebook', '$fone', '$inscricao', '$primeiro_lugar', '$segundo_lugar', '$terceiro_lugar', '$quarto_lugar', '$quinto_lugar', '$data_upload', '$vencimento')";
