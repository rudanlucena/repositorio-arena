...
<body>
      ...
      <div class="main-content">
          <div class="container">
               ...
               <div class="row">
                    <div class="col-md-12">
                        <form action="atualiza_senha.php" method="post" name="partida">
                            <div class="login-form">
                                ...
                                <div class="form-group log-status">
                                    <input type="Password" class="form-control" min="6"  maxlength="25" placeholder="senha atual" id="UserName" name="senha_atual" required>
