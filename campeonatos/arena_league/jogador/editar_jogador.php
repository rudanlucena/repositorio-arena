                  ...
                  ?>
                            ...
                            <div class="login-form">
                                ...
                                <div class="form-group log-status">
                                    ...
                                    <input type="Number" class="form-control"  min="0" max="3" name="cartao_amarelo" value=<?=$jogador['cartao_amarelo']?> required>
                                </div>

                                <div class="form-group log-status">
                                    <label>vermelhos:</label>
                                    <input type="Number" class="form-control"  min="0" max="1" name="cartao_vermelho" value=<?=$jogador['cartao_vermelho']?> required>
                                </div>
