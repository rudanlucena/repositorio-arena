                      ...
                      <div class="table-responsive">
                          ...
                          <table class="cadastro_partida gallery-content listar_jogadores">
                                                        ...
                                                        <thead>
                                                              <tr>
                                                                  <th class="nome_clube_jogadores" colspan="7">
                                                                      <spam class="glyphicon"><img src="../../../images/cartao_amarelo.png"><img src="../../../images/cartao_vermelho.png"></spam>Jogadores Suspensos
                                                                  </th>
                                                               </tr>  
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <?php
                                                                    $jogadores = $db->query("SELECT * from jogadores order by cartao_vermelho desc, cartao_amarelo desc");
                                                                ...
                                                                ?> 
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <div class="time_artilheiro">
                                                                                                <spam class="gallery-title"><?=$jogador['clube']?></spam>                                                                                            
                                                                                            </div> 
                                                                                            </td> 
