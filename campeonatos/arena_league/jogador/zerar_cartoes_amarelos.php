                    ...
                    <div class="col-md-12">
                        ...
                        <?php
                            include("../conexao.php"); 
                                        ...
                                        $sql ="UPDATE jogadores set cartao_amarelo = 0";
                                        $result = mysqli_query( $db, $sql);
                                                     if(!$result)
                                                          echo '<div class="alert alert-danger">
                                                                    <strong>Error!</strong> não foi possivel zerar os cartoes amarelos.
                                                                    <a href="../partida/listar_rodadas.php"><button type="button" class="btn btn-danger">ok</button>
                                                                </div>';
                                                     else{
                                                         echo '<div class="alert alert-success">
                                                                   <strong>Success!</strong> Cartões amarelos zerados com sucesso.
