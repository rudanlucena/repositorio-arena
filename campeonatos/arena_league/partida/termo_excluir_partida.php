        ...
        <div class="container">
            <div class="row">
               <div id="termo_excluir_clube">
                    <div class="col-md-12">
                        <div class="termo"> 
                            AO EXCLUIR UMA PARTIDA SERAM DELETADOS OS PONTOS DISPUTADOS NELA. OS RESULTADOS DAS PARTIDAS AFETAM NA CLASSIFICAÇÃO DO CAMPEONATO (CASO HAJA FASE DE GRUPOS). SOMENTE DELETE PARTIDAS QUE FORAM AGENDADAS POR ENGANO.
                            <div class="acao">
