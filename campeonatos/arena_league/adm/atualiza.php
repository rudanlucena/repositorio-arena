						    ...
						    include("../conexao.php"); 
						                ...
						                if($nova_senha != $confirmacao){
						                	echo '<div class="alert alert-danger">
	                                                    <strong>Error!</strong> não foi possivel atualizar a senha, (os campos "nova senha" devem ser iguais).
	                                                    <a href="../adm/editar_senha.php"><button type="button" class="btn btn-danger">ok</button>
                                                  </div>';
						                }
						                else{
